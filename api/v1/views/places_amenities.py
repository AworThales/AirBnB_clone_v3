...
if getenv('HBNB_TYPE_STORAGE') == 'db':
    ...
    def list_amenities_of_place(place_id):
        ...
        place_objects = [obj.to_dict() for obj in all_place if obj.id == place_id]
        if place_objects == []:
            abort(404)
        list_amenities = []
        for obj in all_place:
            if obj.id == place_id:
    ...
    def create_place_amenity(place_id, amenity_id):
        ...
        all_ameniti = storage.all("Amenity").values()
        amenity_objects = [obj.to_dict() for obj in all_ameniti
